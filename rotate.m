...
%
%    Rotate given image by custom angle
%
...
xr = x;
yr = y;
p = A * [ 1-xr 1-yr ]' + T + [ xr yr ]'; % first corner point
x1=p(1);
y1=p(2);
p= A * [ 1-xr N-yr ]' + T + [ xr yr ]'; % second corner point
x2=p(1);
y2=p(2);
p= A * [ M-xr 1-yr ]' + T + [ xr yr ]'; % third corner point
x3=p(1);
y3=p(2);
p= A * [ M-xr N-yr ]' + T + [ xr yr ]'; % fourth corner point
x4=p(1);
y4=p(2);

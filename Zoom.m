...
%
theta=0.0;
A = [ 1.2*cosd(theta) -(1.2*sind(theta))
      1.2*sind(theta)  1.2*cosd(theta) ];
...
%          end
         ...
         if((1<=minx) && (minx<=M) && (1<=miny) && (miny<=N) && (1<=maxx) && (maxx<=M) && (1<=maxy) && (maxy<=N))
            ...
            I4(x,y,1) = (dx * ((dy * I6(maxx,maxy,1)) + ((1 - dy) * I6(maxx,miny,1)))) + ((1 - dx) * ((dy * I6(minx,maxy,1)) + ((1 - dy) * I6(minx,miny,1)))); 
            
            I4(x,y,2) = (dx * ((dy * I6(maxx,maxy,2)) + ((1 - dy) * I6(maxx,miny,2)))) + ((1 - dx) * ((dy * I6(minx,maxy,2)) + ((1 - dy) * I6(minx,miny,2))));             
            
            I4(x,y,3) = (dx * ((dy * I6(maxx,maxy,3)) + ((1 - dy) * I6(maxx,miny,3)))) + ((1 - dx) * ((dy * I6(minx,maxy,3)) + ((1 - dy) * I6(minx,miny,3)))); 

            I8(x,y) = (dx * ((dy * I7(maxx,maxy)) + ((1 - dy) * I7(maxx,miny)))) +((1 - dx) * ((dy * I7(minx,maxy)) + ((1 - dy) * I7(minx,miny))));
         end
